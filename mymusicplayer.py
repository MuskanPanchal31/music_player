...
listbox = Listbox(right_frame, selectmode = SINGLE, font=("Arial 9 bold"), width=32, bg=co3, fg=co1)
...
stop_button = Button(down_frame, width=40, height = 40, image=img_6, padx=10, bg=co1,font=("Ivy 10"),command=stop_music)
stop_button.place(x=194+28, y=35)

img_7= Image.open("icons/2.png")
img_7 = img_7.resize((30,30))
img_7 = ImageTk.PhotoImage(img_7)
continue_button = Button(down_frame, width=40, height = 40, image=img_7, padx=10, bg=co1,font=("Ivy 10"),command=continue_music)
